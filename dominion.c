...
int effremodel(int card, int choice1, int choice2, struct gameState *state, int handPos, int currentPlayer, int i, int j){
...
void effvillage(int card, struct gameState *state, int handPos, int currentPlayer){
  ...
  //+2 Actions
  state->numActions = state->numActions + 3;//bug
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      effadventurer(card, state, handPos, currentPlayer, drawntreasure, cardDrawn, temphand, z);
      return 0;
			
    case council_room:
      effcouncil_room(card, state, handPos, currentPlayer);
      return 0;
    ...
    case village:
      effvillage(card, state, handPos, currentPlayer);
      return 0;
